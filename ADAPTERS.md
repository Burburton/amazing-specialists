...
│   Adapter          Adapter (v1.0.0)    Adapter Design                       │
...
### Implemented: GitHub Issue Adapter
...
| **Config** | `adapters/github-issue/github-issue.config.json` |
| **README** | `adapters/github-issue/README.md` |
  ...
  "adapters": {
    "orchestrator": [
      ...
      },
      {
        ...
        "interface": "OrchestratorAdapter",
        "compatible_profiles": ["minimal", "full"],
        "description": "GitHub Issue orchestrator adapter"
      },
      {
        "adapter_id": "openclaw",
        "adapter_type": "orchestrator",
