...
> **当前进度**: `003-architect-core`、`004-developer-core`、`005-tester-core` 和 `006-reviewer-core` 已完成。architect、developer、tester 和 reviewer 角色已成为拥有核心能力的 6-role 正式角色。后续 007-008 将依次实现 docs/security 核心能力。
